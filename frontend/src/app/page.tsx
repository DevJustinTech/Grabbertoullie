...
// ⚡ Bolt: Memoized MessageItem to prevent unnecessary re-renders when the parent's `input` state changes.
...
export default function Home() {
  ...
  // ⚡ Bolt: Wraps sendMessage in useCallback to preserve function reference across renders
  ...
  // ⚡ Bolt: Wraps handleSendMessage in useCallback
  const handleSendMessage = useCallback((text: string) => {
    if (!text.trim()) return;
    sendMessage(text.trim());
  }, [sendMessage]);

  // ⚡ Bolt: Wraps handleDownload in useCallback
