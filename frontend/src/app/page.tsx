      ...
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 md:px-8 pb-32 pt-8">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          {messages.map((msg, idx) => (
            ...
            >
              <div
                className={`max-w-[85%] sm:max-w-[75%] px-5 py-3.5 text-[15px] leading-relaxed ${
                  msg.role === "user"
              ...
              >
                ...
                {msg.result && msg.result.status === "success" && msg.result.file_url && (
                  <div className="mt-4 pt-4 border-t border-zinc-100/20">
          ...
          {loading && (
            <div className="flex justify-start animate-in fade-in duration-300">
              <div className="bg-white border border-zinc-200 px-5 py-4 rounded-3xl rounded-tl-sm shadow-sm text-zinc-500 flex gap-1.5 items-center">
