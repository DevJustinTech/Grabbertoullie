...
// ⚡ Bolt: Memoize the MessageItem component to prevent unnecessary re-renders of the entire message list on every keystroke in the input field.
const MessageItem = React.memo(({ msg, handleSendMessage, handleDownload }: { msg: ChatMessage, handleSendMessage: (text: string) => void, handleDownload: (url: string, source?: string) => void }) => {
  return (
    <div
...
export default function Home() {
  ...
  // ⚡ Bolt: Wrap handlers in useCallback to provide stable references to the memoized MessageItem, preventing unnecessary re-renders.
