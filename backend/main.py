...
async def download_endpoint(url: str):
    ...
    try:
        ...
        # Use module-level shared client instead of re-instantiating `httpx.AsyncClient`
        # on every download request. This prevents ~30-50ms instantiation and connection
        # pooling overhead per request.
        client = get_shared_client()
