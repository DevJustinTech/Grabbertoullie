...
async def download_endpoint(url: str):
    ...
    try:
        ...
        # Reusing the shared module-level httpx.AsyncClient to avoid the overhead of spinning up
        # a new client and its internal connection pools for every download request.
        client = get_shared_client()
