...
SANITIZED_DISPOSITION_RE = re.compile(r'[\r\n]')
SANITIZED_FILENAME_RE = re.compile(r'[\r\n"]')
...
async def download_endpoint(url: str):
    ...
    try:
        ...
        if content_disposition:
            ...
            sanitized_disposition = SANITIZED_DISPOSITION_RE.sub('', content_disposition)
            ...
            sanitized_filename = SANITIZED_FILENAME_RE.sub('_', filename)
