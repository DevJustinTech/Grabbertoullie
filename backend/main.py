...
async def download_endpoint(url: str):
    ...
    try:
        ...
        # Use shared httpx.AsyncClient instance instead of instantiating a new one per request.
        # This saves ~30-50ms per download by reusing connection pools and avoiding setup overhead.
        client = get_shared_client()
